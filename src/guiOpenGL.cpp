...
//local variables
static std::string dispString  = "";//"bbTeX!";
...
int guiInit(){
	...
	float tex_x, tex_y;
	if (EXIT_SUCCESS
			!= bbutil_load_texture("app/native/bbtex_bkgd.png",
...
void guiHandleAddDist(){
	...
	case 2:
		...
		navigator_invoke("http://github.com/breakeyd/bbtex/tree/master/texsrc/distros-zipped",NULL);//redirects to github to download new dists
	break;
	}
}
