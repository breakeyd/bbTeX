...
static std::string getTexBin(){
	...
	{
		fprintf(stderr,"Could not load tex distribution settings. Reverting to bbtexlive-2012basic.\n");
		std::string TEX_BIN="$HOME/texlive/bbtexlive-2012basic/bin/arm-unknown-nto-qnx6.5.0eabi";
	}
	return TEX_BIN;
}
